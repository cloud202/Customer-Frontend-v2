  ...
  return (
    ...
    <Grid templateColumns="repeat(6,1fr)">
        ...
        <GridItem colSpan={{base: '6', sm: '6', md: '6',lg: '5' }} className= "project-background" >
          ...
          <Text className='sub-title' fontSize={{ base: '14px',sm: '20px', md: '24px', lg: '28px' }} fontWeight={400}>Welcome to modX, Define Modernisation Journey For Your Customer</Text>
